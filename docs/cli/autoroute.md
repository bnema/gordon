...
When auto-route is enabled, Gordon can create routes automatically from container image labels. The domain allowlist restricts which domains auto-route may use, preventing untrusted images from claiming arbitrary domains.
