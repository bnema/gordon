# Gordon v2 Configuration (HCL format)
...
# A    blog.example.com     → YOUR_SERVER_IP
# A    staging.example.com  → YOUR_SERVER_IP
# A    registry.example.com → YOUR_SERVER_IP

# Docker workflow:
# docker tag myapp:latest registry.example.com/myapp:latest
# docker push registry.example.com/myapp:latest
# → Gordon automatically deploys to app.example.com! 🚀