...
func (r *Renderer) Render(data interface{}, a *appserver.App) (string, error) {
	if r.ParseError != nil {
...
func GetHTMLRenderer(mainPath string, filename string, fs fs.FS, a *appserver.App, fragmentsPath ...string) (*Renderer, error) {
