...
func createDBAccount(a *appserver.App) (*db.Account, error) {
	account := &db.Account{
		ID: generateUUID(),
	}
...
func CheckDBAccountExists(a *appserver.App, accountID string) (bool, error) {
	var exists bool
...
func PopulateAccountFromDB(a *appserver.App) error {
