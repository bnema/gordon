// the update command is used to update gordon's executable to the latest version

// Heavily inspired by Pocketbase's update command
// See: https://github.com/pocketbase/pocketbase/blob/master/plugins/ghupdate/ghupdate.go
package cmd
